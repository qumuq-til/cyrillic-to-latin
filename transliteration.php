...
class TransliterateCyrillicMethod
{
	...
	public static function process($text)
	{
		...
		$text = preg_replace('/\bсюнгю/iu', 'süñü', $text);
		$text = preg_replace('/\bСЮНГЮ/u', 'SÜÑÜ', $text);
		$text = preg_replace('/\bгёнгю/iu', 'göñü', $text);
		$text = preg_replace('/\bГЁНГЮ/u', 'GÖÑÜ', $text);
		$text = preg_replace('/нгю\b/iu', 'ngü', $text);
		$text = preg_replace('/НГЮ\b/u', 'NGÜ', $text);
		$text = preg_replace('/нгюсю\b/iu', 'ngüsü', $text);
		$text = preg_replace('/НГЮСЮ\b/u', 'NGÜSÜ', $text);
		$text = preg_replace('/инге\b/iu', 'iñe', $text);
		$text = preg_replace('/ИНГЕ\b/u', 'IÑE', $text);
		$text = preg_replace('/гюнге\b/iu', 'günge', $text);
		$text = preg_replace('/ГЮНГЕ\b/u', 'GÜNGE', $text);
		$text = preg_replace('/юнге\b/iu', 'üñe', $text);
		$text = preg_replace('/ЮНГЕ\b/u', 'ÜÑE', $text);
		$text = preg_replace('/нге\b/iu', 'nge', $text);
